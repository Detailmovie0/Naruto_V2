    ...
    try:
        ...
        if pm_search:
            ...
            await message.reply_text(
                text=(
                    f"<b>🙋 ʜᴇʏ {user} 🌿 ,\n\n"
                    "<blockquote>ʏᴏᴜ ᴄᴀɴ ꜱᴇᴀʀᴄʜ ᴍᴏᴠɪᴇꜱ, ꜱᴇʀɪᴇꜱ, ᴀɴɪᴍᴇꜱ, ᴋ-ᴅʀᴀᴍᴀ, ᴅᴀɪʟʏ ꜱʜᴏᴡꜱ & ᴍᴀɴʏ ᴍᴏʀᴇ ᴏɴʟʏ ᴏɴ ᴏᴜʀ ᴏꜰꜰɪᴄɪᴀʟ ᴍᴏᴠɪᴇ ʀᴇQᴜᴇꜱᴛ ɢʀᴏᴜᴘ. ᴡᴇ ᴀʀᴇ ɴᴏᴛ ᴀʟʟᴏᴡᴇᴅ ᴛᴏ ꜱᴇᴀʀᴄʜ ɪɴ ᴅɪʀᴇᴄᴛ ʙᴏᴛ ( ᴘᴍ ). ᴘʟᴇᴀꜱᴇ ᴊᴏɪɴ ᴏᴜʀ ᴏꜰꜰɪᴄɪᴀʟ ᴍᴏᴠɪᴇ ʀᴇQᴜᴇꜱᴛ ɢʀᴏᴜᴘ ʙʏ ᴄʟɪᴄᴋɪɴɢ ᴏɴ ᴛʜᴇ 𝐌𝐨𝐯𝐢𝐞 𝐑𝐞𝐪𝐮𝐞𝐬𝐭 𝐆𝐫𝐨𝐮𝐩 ʙᴜᴛᴛᴏɴ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ᴀɴᴅ ꜱᴇᴀʀᴄʜ ᴛʜᴇʀᴇ ʏᴏᴜʀ ᴄᴏɴᴛᴇɴᴛ. 👇.</blockquote>\n\n"
                    "<blockquote>"
                    "आप केवल हमारे 𝐌𝐨𝐯𝐢𝐞 𝐑𝐞𝐪𝐮𝐞𝐬𝐭 𝐆𝐫𝐨𝐮𝐩 🌿 पर ही ʀᴇQᴜᴇꜱᴛ ꜱᴇᴀʀᴄʜ कर सकतें हैं । "
                    "आपको ᴅɪʀᴇᴄᴛ ʙᴏᴛ ( ᴘᴍ ) पर ᴄᴏɴᴛᴇɴᴛ ꜱᴇᴀʀᴄʜ करने की ᴘᴇʀᴍɪꜱꜱɪᴏɴ नहीं दी गई है। कृपया नीचे दिए गए 𝐌𝐨𝐯𝐢𝐞 𝐑𝐞𝐪𝐮𝐞𝐬𝐭 𝐆𝐫𝐨𝐮𝐩 वाले ʙᴜᴛᴛᴏɴ पर क्लिक करके हमारे ᴏꜰꜰɪᴄɪᴀʟ ʀᴇQᴜᴇꜱᴛ ɢʀᴏᴜᴘ को ᴊᴏɪɴ करके वहां पर अपनी मनपसंद ʀᴇQᴜᴇꜱᴛ ꜱᴇᴀʀᴄʜ कजिए। 👇।"
                    "</blockquote></b>"
...
async def advantage_spoll_choker(bot, query):
    ...
    if files:
        ...
        btn = InlineKeyboardMarkup(
            [[InlineKeyboardButton("Cʟɪᴄᴋ ʜᴇʀᴇ ʀᴇǫᴜᴇsᴛ ᴛᴏ sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ", url=OWNER_LNK)]])
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        try:
            ...
            if btn:
                ...
                try:
                    ...
                    pass
                await query.answer(
                    f"ᴊᴏɪɴ ☛ ᴏғғɪᴄɪᴀʟ ᴄʜᴀɴɴᴇʟ {query.from_user.first_name},\n\n"
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton('ᴅɪꜱᴄʟᴀɪᴍᴇʀ', callback_data='help'),
        ...
        buttons = [[
                InlineKeyboardButton(' Sᴇɴᴅ Dᴏɴᴀᴛᴇ Sᴄʀᴇᴇɴsʜᴏᴛ Hᴇʀᴇ', url='https://t.me/dvl_naruto_06')
            ],[
      ...
      #  ],[
        ...
        try:
            btn = [[
                InlineKeyboardButton('• ꜱᴇɴᴅ  ᴘᴀʏᴍᴇɴᴛ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ •', url='https://t.me/dvl_naruto_06'),
            ],[
    ...
    try:
        if not spoll:
            ...
            if len(message.text) < 100:
                ...
                stick_id = "CAACAgUAAxkBAAIQZ2ky_NXSSaHQobt7t8TRUKyfhhDhAAIcGQACCTkAAVQK3_TpiKCW7zYE"
                ...
                if not files:
                    if settings.get("spell_check"):
                        ai_sts = await m.edit('𝐏𝐥𝐞𝐚𝐬𝐞 𝐰𝐚𝐢𝐭 😓, 𝐀𝐢 𝐜𝐡𝐞𝐜𝐤𝐢𝐧𝐠 𝐲𝐨𝐮𝐫 𝐬𝐩𝐞𝐥𝐥𝐢𝐧𝐠 ...')
        ...
        if imdb:
            ...
            if ULTRA_FAST_MODE:
                if settings.get('button'):
                    cap = f"<b>❍ ꜰɪʟᴇ ɴᴀᴍᴇ : <code>{search}</code>\n❍ shoᴡ ɪɴ : <code>{remaining_seconds} Sᴇᴄᴏɴᴅs</code>\n\n❍ ʀᴇǫᴜᴇsᴛᴇᴅ ʙʏ 🌿 : {message.from_user.mention}\n❍ ᴘᴏᴡᴇʀᴇᴅ ʙʏ : 🌿 {message.chat.title or temp.B_LINK or 'ᴅʀᴇᴀᴍxʙᴏᴛᴢ'} \n\n<u>Your Requested Files Are Here</u> \n\n</b>"
                else:
                    cap = f"<b>❍ ꜰɪʟᴇ ɴᴀᴍᴇ : <code>{search}</code>\n❍ shoᴡ ɪɴ : <code>{remaining_seconds} Sᴇᴄᴏɴᴅs</code>\n\n❍ ʀᴇǫᴜᴇsᴛᴇᴅ ʙʏ 🌿 : {message.from_user.mention}\n❍ ᴘᴏᴡᴇʀᴇᴅ ʙʏ : 🌿 {message.chat.title or temp.B_LINK or 'ᴅʀᴇᴀᴍxʙᴏᴛᴢ'} \n\n<u>Your Requested Files Are Here</u> \n\n</b>"
                    for idx, file in enumerate(files, start=1):
                        cap += f"<b>\n{idx}. <a href='https://telegram.me/{temp.U_NAME}?start=file_{message.chat.id}_{file.file_id}'>[{get_size(file.file_size)}] {clean_filename(file.file_name)}\n</a></b>"
